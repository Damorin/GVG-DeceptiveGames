package tracks.singlePlayer.agentsForDeceptiveGames.CatLinux3;
...
/**
 * Created with IntelliJ IDEA. User: Jialin Liu Date: 23/05/15 Time: 10:17
 */
public class Agent extends AbstractPlayer {
	...
	private int buffer_init_size = 8;
	...
	public void evaluatePopulation(StateObservation stateObs) {
		for (int i = 0; i < population.length; i++) {
			...
			current_individual.evaluate(stateCopy);
		}
	}
