package tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2;
...
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.controller.MctsController;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.gnu.trove.impl.Constants;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.gnu.trove.list.array.TByteArrayList;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.gnu.trove.list.array.TDoubleArrayList;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.gnu.trove.list.array.TIntArrayList;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.gnu.trove.map.hash.TIntIntHashMap;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.heuristics.events.EventKnowledge;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.utils.OrderedIntPair;
import tracks.singlePlayer.agentsForDeceptiveGames.MaastCTS2.utils.Pathfinder;
...
public class KnowledgeBase {
	...
	public void addEventKnowledge(double previousScore, int previousNumEvents, Vector2d previousAvatarPos, 
		...
		TreeSet<Event> newEventSet = newState.getEventsHistory();
