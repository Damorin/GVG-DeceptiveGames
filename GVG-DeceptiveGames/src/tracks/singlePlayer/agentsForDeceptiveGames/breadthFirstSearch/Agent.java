package tracks.singlePlayer.agentsForDeceptiveGames.breadthFirstSearch;
...
public class Agent extends AbstractPlayer{
	...
	public ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
		...
		queue.add(new Node(null, ACTIONS.ACTION_NIL, stateObs));
		...
		ArrayList<ACTIONS> possibleActions = stateObs.getAvailableActions();
	...
	public class Node {
		...
		public Node(Node parent, ACTIONS action, StateObservation state){
			this.parent = parent;
			this.action = action;
			this.state = state;
		}
