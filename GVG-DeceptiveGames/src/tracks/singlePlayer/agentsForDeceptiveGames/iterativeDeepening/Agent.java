package tracks.singlePlayer.agentsForDeceptiveGames.iterativeDeepening;
...
public class Agent extends AbstractPlayer{
	...
	public ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
		...
		stack.push(new Node(stateObs, null, ACTIONS.ACTION_NIL));
	...
	class Node{
		...
		public Node(StateObservation state, Node parent, ACTIONS action){
			this.state = state;
			this.parent = parent;
			this.action = action;
			this.depth = 1;
