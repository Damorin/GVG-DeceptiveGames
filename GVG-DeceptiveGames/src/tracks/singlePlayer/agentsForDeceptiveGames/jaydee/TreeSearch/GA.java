...
import tracks.singlePlayer.agentsForDeceptiveGames.jaydee.Agent;
import tracks.singlePlayer.agentsForDeceptiveGames.jaydee.GameInfo;
import tracks.singlePlayer.agentsForDeceptiveGames.jaydee.Node;
import tracks.singlePlayer.agentsForDeceptiveGames.jaydee.NodePool;
import tracks.singlePlayer.agentsForDeceptiveGames.jaydee.SortedList;

public class GA extends TreeSearch {
    public static int    GA_POPULATION_SIZE = 50; // 10,25,50,100
    public static int    GA_MAX_LENGTH      = 5;
    public static double GA_MUTATION_CHANCE = 0.5;
