...
public class ArcadeMachine {
     ...
     */
    public static StatSummary runGames(String game_file, String[] level_files, int level_times,
                                       String agentName, String[] actionFiles, int randomSeed, boolean print) {
        VGDLFactory.GetInstance().init(); //This always first thing to do.
        VGDLRegistry.GetInstance().init();
        ...
        for (String level_file : level_files) {
            ...
            for (int i = 0; i < level_times; ++i) {
                ...
                if (toPlay.getWinner() == Types.WINNER.PLAYER_WINS) {
                    scores.add(toPlay.getWinner().key());
                }
